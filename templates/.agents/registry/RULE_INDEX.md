...
동기화 대상 전체 — 예: `execution.md`, `verification.md`, `planning.md`, `reporting.md`, `routing.md`, `principles.md`, `error_patterns.md`, `code_quality_lifecycle.md`, `memory_hygiene.md`, `runtime_edit_tools.md` 등.
