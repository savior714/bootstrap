...
- dirty-write 금지
- 추상화 남발 금지
- **O2 Strengthened**: 구현 편집은 메인 금지([orchestration.md §5 O0](./orchestration.md#5-직접-실행-예외-o0) 예외) — `general` Task + [orchestration.md §4](./orchestration.md#4-handoff-계약-task-prompt-필수) handoff
