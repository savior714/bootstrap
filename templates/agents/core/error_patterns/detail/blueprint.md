...
StrReplace({ "filePath": "PLAN.md", "oldString": "Status: done", "newString": "Status: todo" })  # ❌ 금지
...
# StrReplace로 Status/Conclusion 직접 수정 — plan-task-close CLI만 허용
# Conclusion placeholder [완료 시 기입] 또는 25자 미만 — plan-lint FAIL
