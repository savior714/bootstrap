...
6d. **Task Goal SSOT Gate**: Task Goal 작성·자가검사 시 [task-decomposition.md](../skills/plan/references/task-decomposition.md) §Task Goal 작성 SSOT — BAD/GOOD 3종(추상·엔티티 없음·TDD Red 누락)·작성 공식·예외 목록. TEMPLATE MUST NOT와 함께 참고 — [plan/SKILL.md](../skills/plan/SKILL.md) Phase W3.
