...
| :--- | :--- | :--- | :--- |
| `/plan` | 통합 심층 설계 및 태스크 분해 | [plan/SKILL.md](../skills/plan/SKILL.md) | [plan.md](../workflows/plan.md) |
...
슬래시·키워드는 **IDE가 자동 실행하지 않음**. 아래 경로를 **Read** 후 실행 ([error_patterns/detail/workflow.md §16.1](../core/error_patterns/detail/workflow.md#161)).

| 키워드 (예) | Read |
| :--- | :--- |
| plan, blueprint, 설계 | [workflows/plan.md](../workflows/plan.md) · [skills/plan/SKILL.md](../skills/plan/SKILL.md) · [skills/plan/references/task-decomposition.md](../skills/plan/references/task-decomposition.md) §Task Goal 작성 SSOT |
...
| `/plan` | [plan/SKILL.md](../skills/plan/SKILL.md) | [plan.md](../workflows/plan.md) |
