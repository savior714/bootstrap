...
# trigger: /investigate  ← catalog metadata only; Read this file before executing (error_patterns/detail/workflow.md#161)
level: Recommended
...
- **오케스트레이션**: [orchestration_detail.md#7](../core/orchestration_detail.md#7-워크플로-매핑-pointer) — 역할 분리·이관 규칙 SSOT.
