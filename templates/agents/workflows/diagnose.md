...
# trigger: /diagnose  ← catalog metadata only; Read this file before executing (error_patterns/detail/workflow.md#161)
level: Recommended
...
**프로토콜 SSOT**: [agents/skills/diagnose/SKILL.md](../skills/diagnose/SKILL.md) — 실행 전 Read 후 Phase 1~6·**Phase 2.5 Context7 always-on**을 따른다.

- **오케스트레이션**: [orchestration_detail.md §5](../core/orchestration_detail.md#5-메인-에이전트-역할-경계) — **메인 직접 수행** — StrReplace / Write / Shell / Grep / Read 모두 허용. subagent 위임 금지.
