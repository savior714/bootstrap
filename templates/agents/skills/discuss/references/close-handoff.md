...
**공통 계약(메뉴 B·금지 문구)**: [plan/handoff-contract.md](../../plan/references/handoff-contract.md)
...
2. `DISCUSS_*.md` §3·§2·엣지 불릿을 입력으로 `docs/plans/PLAN_<slug>.md` 작성(Origin Intent · Edge Case Trace · **`## Agent Execution Pack`** 포함) → [plan/SKILL.md](../../plan/SKILL.md) Phase W3 **잡무 완료 5문항** → `just plan-preread` → `just plan-lint` PASS.
...
| 메뉴 B **PLAN 전체 실행** 완료 후 | **review** — 세션 구현 점검 MUST | Execute closeout 후 review **생략** |

**Execute → review SSOT**: [plan/handoff-from-execute-to-review.md](../../plan/references/handoff-from-execute-to-review.md)
