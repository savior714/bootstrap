...
> **도구 별칭**: 본 SKILL의 `AskQuestion` 지시는 `question` 도구 호출에도 동일 적용([AGENTS.md §1.3](../../../AGENTS.md#13-quick-pick--interactive-refine)).
...
**2단계 `(권장)` 선정 직후**, `AskQuestion`/`question`(병용) `options[]` 순서를 **재정렬**한다 ([AGENTS.md §1.3](../../../AGENTS.md#13-quick-pick--interactive-refine) · Cursor AskQuestion 도구 힌트와 정합).
