...
4. **안내**: [references/handoff-to-plan.md](references/handoff-to-plan.md) §emit 직후 — **산출물 요약 턴** + 메뉴 B. `@` + `/plan` 안내 **금지**.
...
**emit 후 안내 SSOT**: [references/handoff-to-plan.md](references/handoff-to-plan.md) — plan-lint PASS 직후 **이 PLAN 전체 순차 실행** 메뉴 B.
