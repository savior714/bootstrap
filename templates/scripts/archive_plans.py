...
Usage:
  ...
  python3 scripts/archive_plans.py archive --skip-unified-sync PLAN.md # unified sync 생략(비권장)
  python3 scripts/archive_plans.py archive --skip-linear-sync PLAN.md # Linear strict 동기화 생략(오프라인·이슈 미존재)
  python3 scripts/archive_plans.py unarchive PLAN.md   # archive -> plans root (참조 역치환)
